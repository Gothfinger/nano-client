    ...
    std::string CheatVersion = "Version 1.1.5";
    std::string GameVersion = "v3.0.82.42"; // [Miscellaneous]->GameVersion
    ...
    // HUD
    constexpr long OFF_VIEWRENDER = 0x76e9ab8; // [Miscellaneous]->ViewRender
    constexpr long OFF_VIEWMATRIX = 0x11a350; // [Miscellaneous]->ViewMatrix
     
    // Buttons
    constexpr long OFF_INATTACK = 0x076e9bc0; // [Buttons]->in_attack
    constexpr long OFF_IN_JUMP = 0x076e9cb8; // [Buttons]->in_juFmp
    constexpr long OFF_IN_DUCK = 0x076e9db0; // [Buttons]->in_duck
    constexpr long OFF_IN_FORWARD = 0x076e9af0; // [Buttons]->in_forward
    constexpr long OFF_IN_BACKWARD = 0x076e9b18; // [Buttons]->in_backward
    ...
    constexpr long OFF_OBSERVER_LIST = 0x01f621d0 + 0x20c8;   //observerList: 48 8B 0D ? ? ? ? 48 85 C9 74 ? 48 8B 01 FF ? ? 48 85 C0 74 ? 48 63 4E 38
    constexpr long OFF_OBSERVER_LIST_IN_ARRAY = 0x0974; // 0x964 before
    ...
    constexpr long OFF_GLOW_HIGHLIGHTS = 0xb1db5a0; // [Miscellaneous]->HighlightSettings
