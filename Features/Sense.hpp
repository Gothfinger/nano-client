	...
	void RenderWatermark(ImDrawList* Canvas, LocalPlayer* Myself, Overlay OverlayWindow) {
		...
		if (Features::Watermark::Watermark) {
			...
			if (Features::Watermark::Name) {
				ImGui::TextColored(ImVec4(Features::Watermark::NameColor[0], Features::Watermark::NameColor[1], Features::Watermark::NameColor[2], Features::Watermark::NameColor[3]), "nano-client ");
				ImGui::SameLine();
				ImGui::Text(" - ");
				ImGui::SameLine();
