...
namespace Features {
    ...
    namespace Aimbot {      
        ...
        int BindMethod = 0; // 0 = OnFire & OnADS (Doesn't work?), 1 = Keybind LeftMouse & RightMouse
        int AimbotMode = 0; // 0 = Cubic Beizer (xap-client), 1=  Grinder (Possibly linear?), 2 = [New] Cubic Beizer (Nika)
        int InputMethod = 0; // 0 = MoveMouse, 1 = MemoryWrite (Write To ViewAngles - memory::write)
